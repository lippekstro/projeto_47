            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                    <div class="card shadow-sm">
                        ...
                        <div class="d-flex justify-content-evenly align-items-center">
                            <a href="/projeto_47/views/admin/listar_promocoes.php"><button type="button" class="btn btn-sm btn-outline-secondary m-3">Visualizar</button></a>
                            <a href="/projeto_47/views/admin/adicionar_promocoes.php"><button type="button" class="btn btn-sm btn-outline-secondary m-3">Adicionar</button></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3 mb-3">
