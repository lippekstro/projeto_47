            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="d-flex justify-content-evenly align-items-center">
                            <a href="/projeto_47/views/admin/lista_categoria_promo.php"><button type="button" class="btn btn-sm btn-outline-secondary m-1">Visualizar</button></a>
                            <a href="/projeto_47/views/admin/cadastro_categoria_promo.php"><button type="button" class="btn btn-sm btn-outline-secondary m-1">Adicionar</button></a>
                        </div>
                    </div>
                </div>
                <div class="col">
