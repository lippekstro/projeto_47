        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
            <form class="row gy-2 gx-3 align-items-center" action="/projeto_47/controllers/editar_evento_controller.php" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="text" id="tituloEvento" name="tituloEvento" value="<?php echo $row['titulo']; ?>" required><br>
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="latitudeEvento">Latitude:</label>
                    <input class="form-control" type="text" id="latitudeEvento" name="latitudeEvento" value="<?php echo $row['latitude']; ?>" required><br>
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="longitudeEvento">Longitude:</label>
                    <input class="form-control" type="text" id="longitudeEvento" name="longitudeEvento" value="<?php echo $row['longitude']; ?>" required><br>
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="localEvento">Local do Evento:</label>
                    <input class="form-control" type="text" id="localEvento" name="localEvento" value="<?php echo $row['local_evento']; ?>" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" id="descricao_evento" name="descricao_evento" required><?php echo $row['descricao_evento']; ?></textarea><br>
                </div>
